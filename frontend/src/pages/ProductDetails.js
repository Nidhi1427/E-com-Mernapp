...
import { useNavigate, useParams } from 'react-router-dom'  // ✅ FIXED: Removed extra space
import SummaryApi from '../common'
import { FaStar } from "react-icons/fa";
import { FaStarHalf } from "react-icons/fa";
import displayINRCurrency from '../helpers/displayCurrency';
import VerticalCardProduct from '../components/VerticalCardProduct.js.BROKEN';
import CategroyWiseProductDisplay from '../components/CategroyWiseProductDisplay';  // ✅ CORRECT filename
...
const fetchUserAddToCart = context?.fetchUserAddToCart; 
  ...
  const fetchProductDetails = async () => {
    ...
    setLoading(false)
    const dataResponse = await response.json()  // ✅ FIXED: dataReponse → dataResponse
  ...
  const handleZoomImage = useCallback((e) => {  // ✅ FIXED: Removed zoomImageCoordinate from deps
    setZoomImage(true)
